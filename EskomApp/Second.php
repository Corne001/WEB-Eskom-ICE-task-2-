...
$sql ="Select Distinct SuburbName from stage";
...
.select {
  padding-bottom: 20px;
  border-bottom: 0px solid #28333f;
}
.select:before {
  display: none;
}
...
<select  style="font-size: 20px; width:15% ; height: 5%;" id="suburbs" onchange="selectSub()">
	<?php while ($rows = mysqli_fetch_array($res)){
	?>
	<option value="<?php  echo $rows['SuburbName'];  ?>"><?php echo $rows['SuburbName'];  ?></option>
